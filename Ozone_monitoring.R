...
#should do some stats to compare the ozone of two sites, TIme interval is variable so Mann Whitney U Test probably most appropriate rather than specifically a time series test
